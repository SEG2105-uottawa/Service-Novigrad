 ...
 * Use the {@link ManageServiceRequests#newInstance} factory method to
 * create an instance of this fragment.
 */
public class ManageServiceRequests extends Fragment {

    ServiceReqManagerAdapter adapter;
    ...
    private ServiceReqManagerAdapter createServiceReqManager(ArrayList<ServiceRequest> requests, Context context){
        RecyclerView serviceReqRecycler = getView().findViewById(R.id.ServiceRequestRecycleView);
        ServiceReqManagerAdapter adapter = new ServiceReqManagerAdapter(context, requests);
